...
use crate::validator::array::extract_array_uniqueness_validator_from_meta_path;
...
pub fn extract_validator_from_nested_meta_path(
    ...
    match path_ident.to_string().as_ref() {
        "unique_items" => return Some(extract_array_uniqueness_validator_from_meta_path(field)),
        v => {
